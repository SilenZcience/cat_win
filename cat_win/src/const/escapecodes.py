...
DECSCUSR_STYLE_BLOCK_BLINK     = f"{ESC_CODE}[1 q"
DECSCUSR_STYLE_BLOCK           = f"{ESC_CODE}[2 q"
DECSCUSR_STYLE_UNDERLINE_BLINK = f"{ESC_CODE}[3 q"
DECSCUSR_STYLE_UNDERLINE       = f"{ESC_CODE}[4 q"
DECSCUSR_STYLE_BAR_BLINK       = f"{ESC_CODE}[5 q"
DECSCUSR_STYLE_BAR             = f"{ESC_CODE}[6 q"
DECSCUSR_CURSOR_STYLE = {
    'default'        : DECSCUSR_STYLE_DEFAULT,
    'block_blink'    : DECSCUSR_STYLE_BLOCK_BLINK,
    'block'          : DECSCUSR_STYLE_BLOCK,
    'underline_blink': DECSCUSR_STYLE_UNDERLINE_BLINK,
    'underline'      : DECSCUSR_STYLE_UNDERLINE,
    'bar_blink'      : DECSCUSR_STYLE_BAR_BLINK,
