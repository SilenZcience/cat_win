...
class TestEnvironment(TestCase):
    ...
    @patch('os.environ', {'PATH': '/usr/bin\\'})
    @patch('cat_win.src.service.helper.environment.on_windows_os', False)
    def test_get_py_executable_linux_path_d(self):
        self.assertEqual(get_py_executable(), 'python3')


    @patch('sys.executable', 'C:/Users/user/AppData/Local/Programs/Python/Python39/python.exe')
    @patch('os.environ', {'PATH': 'C:/Users/user/AppData/Local/Programs/Python/Python39'})
    ...
    @patch('sys.executable', 'C:/Users/user/AppData/Local/Programs/Python/Python39/python3.exe')
    @patch('os.environ', {'PATH': 'C:/Users/user/AppData/Local/Programs/Python/Python39\\'})
    @patch('cat_win.src.service.helper.environment.on_windows_os', True)
    def test_get_py_executable_windows_path_d(self):
        self.assertEqual(get_py_executable(), 'python3')

    @patch('sys.executable', 'C:/Users/user/AppData/Local/Programs/Python/Python39/py')
    @patch('os.environ', {'PATH': 'C:/Users/user/AppData/Local/Programs/Python/Python39\\'})
    @patch('cat_win.src.service.helper.environment.on_windows_os', True)
    ...
    @patch('sys.executable', 'C:/Users/user/AppData/Local/Programs/Python/Python39/python4.exe?')
    @patch('os.environ', {})
    @patch('cat_win.src.service.helper.environment.on_windows_os', True)
    def test_get_py_executable_windows_nopath_a(self):
        self.assertEqual(get_py_executable(), 'C:/Users/user/AppData/Local/Programs/Python/Python39/python4.exe?')
    ...
    @patch('sys.executable', 'C:/Program Files/Python/Python39/python4.exe?')
    @patch('os.environ', {})
    @patch('cat_win.src.service.helper.environment.on_windows_os', True)
    def test_get_py_executable_windows_nopath_space_a(self):
        self.assertEqual(get_py_executable(), '"C:/Program Files/Python/Python39/python4.exe?"')
