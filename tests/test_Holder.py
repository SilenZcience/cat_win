...
test_file_edge_case_1 = script_dir + "/test_holderEdgeCase_1.txt"
test_file_edge_case_2 = script_dir + "/test_holderEdgeCase_2.txt"
test_file_edge_case_3 = script_dir + "/test_holderEdgeCase_3.txt"
holder = Holder()
