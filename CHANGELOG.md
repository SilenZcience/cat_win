...
- cat_win will now detect simple rar-archives and display the contained files.
...
- fixed visual Bug inside diffviewer.
...
- added `-?`, `--diff` parameter to open two files in a simple side-by-side diff-viewer.
